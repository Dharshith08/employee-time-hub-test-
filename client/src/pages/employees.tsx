...
function EnrollmentGuide() {
  return (
    <div className="space-y-4 rounded-2xl bg-primary/5 border border-primary/10 p-5 animate-in slide-in-from-right duration-500">
      <div className="flex items-center gap-2 text-primary">
        <Lightbulb className="size-5" />
        <h4 className="font-bold tracking-tight">Pro Enrollment Tips</h4>
      </div>
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-wider text-emerald-600">
            <Check className="size-3" /> Do These
          </div>
          <ul className="text-xs space-y-1.5 text-muted-foreground list-disc pl-4">
            <li>Ensure bright, even lighting on the face.</li>
            <li>Look directly at the camera at first.</li>
            <li>Turn head slowly left and right.</li>
            <li>Keep a neutral or natural expression.</li>
          </ul>
        </div>
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-[11px] font-bold uppercase tracking-wider text-rose-600">
            <X className="size-3" /> Avoid These
          </div>
          <ul className="text-xs space-y-1.5 text-muted-foreground list-disc pl-4">
            <li>Harsh backlighting (windows behind you).</li>
            <li>Wearing masks, sunglasses, or heavy hats.</li>
            <li>Moving too fast during capture.</li>
            <li>Blurry or out-of-focus preview.</li>
          </ul>
        </div>
      </div>
    </div>
                    ...
                    <div className="space-y-4">
                      <div className="relative overflow-hidden rounded-[1.9rem] border border-border/70 bg-black">
                        ...
                        <div className="grid gap-3 sm:grid-cols-3">
                          <div className="rounded-xl bg-muted/30 px-3 py-2 border border-border/40">
                            <p className="text-[10px] uppercase tracking-[0.18em] text-muted-foreground">Captured</p>
                            <p className="text-lg font-bold text-foreground">{datasetPhotos.length}</p>
                          </div>
                          <div className="rounded-xl bg-muted/30 px-3 py-2 border border-border/40">
                            <p className="text-[10px] uppercase tracking-[0.18em] text-muted-foreground">Minimum</p>
                            <p className="text-lg font-bold text-foreground">{MIN_DATASET_SAMPLES}</p>
                          </div>
                          <div className="rounded-xl bg-muted/30 px-3 py-2 border border-border/40">
                            <p className="text-[10px] uppercase tracking-[0.18em] text-muted-foreground">Quality</p>
                            <p className={`text-lg font-bold ${datasetReady ? 'text-emerald-600' : 'text-amber-600'}`}>
                              {datasetReady ? "Strong" : "Weak"}
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="rounded-xl border border-dashed border-border/80 bg-muted/10 px-4 py-3 text-sm">
                        {datasetReady ? (
                          <div className="flex items-start gap-2 text-emerald-700">
                            <CheckCircle2 className="mt-0.5 size-4 shrink-0" />
                            <p className="text-xs">
                              Dataset captured. Saving will target <strong>{datasetPhotos.length} samples</strong> for the strongest model accuracy.
                            </p>
                          </div>
                        ) : (
                          <div className="flex items-start gap-2 text-muted-foreground">
                            ...
                            <p className="text-xs">
                              Capture at least {MIN_DATASET_SAMPLES} photos. For better accuracy, aim for 60-100 with natural face movements.
                            </p>
                          </div>
                        )}
                      </div>
